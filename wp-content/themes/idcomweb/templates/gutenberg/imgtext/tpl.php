...
?>
<section id="<?php echo esc_html($id); ?>" class="section imgtext mht96 mhb64 wow fadeIn" data-wow-duration="0.5s" data-wow-delay="1.25s" style="background-image: url(<?php echo esc_url($bg['url']); ?>);<?php if($testimonials == false) : ?>margin-left: 2%;background-position: left;<?php else : ?>margin-right:2%;background-position: right;<?php endif; ?>">
