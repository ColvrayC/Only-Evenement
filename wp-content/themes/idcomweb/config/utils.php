...
function get_top_parent_page_id() {
    ...
    if ($ancestors) {
        ...
        return $ancestors[sizeof($ancestors)-2]==NULL?$post->ID: $ancestors[sizeof($ancestors)-2];
...
function is_home_page($id){

	return get_option( 'page_on_front' )==$id;
 ...
 * Remove width/height default attributes from images

 * Used with `the_post_thumbnail()` function.
...
function idcomcrea_menu($location){
	?>
	<nav class="navbar navbar-expand-md navbar-light bg-faded">
	   ...
	   wp_nav_menu(array(
		 ...
		 'menu_id'         => false,
		 'menu_class'      => 'navbar-nav mr-auto justify-content-around',
		 'depth'           => 2,
